...
const CommunityHelp = () => {
    ...
    useEffect(() => {
        ...
        console.log("Stored Agenda:", storedAgenda);
        const filteredAgenda = storedAgenda.filter(
            (item) => item.date === selectedDate
        );
        console.log("Filtered Agenda:", filteredAgenda);
    ...
    return (
        <div className="bg-accent min-h-screen p-4">
            <h1 className="text-secondary font-bold text-2xl text-center mb-4">Community Help Page</h1>
